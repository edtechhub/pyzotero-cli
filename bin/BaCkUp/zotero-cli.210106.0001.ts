...
*/
  ...
  parser_collections.addArgument('--key', { action:'',help: 'Show all the child collections of collection with key. You can provide the key as zotero-select link (zotero://...) to also set the group-id.' })
  ...
  parser_post.addArgument('uri', { nargs: '1', help: 'TODO: document' })
  ...
  parser_put.addArgument('uri', { nargs: '1', help: 'TODO: document' })
